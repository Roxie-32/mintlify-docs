---
title: 'Quickstart'
description: 'Start building great  documentation in under 5 minutes'
---
...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Preview changes">
    ...
    CLI  to render these changes locally. 1. Install the
...
Add content directly in your files with MDX syntax and React components. hi guys You can use any of our components, or even build your own.
